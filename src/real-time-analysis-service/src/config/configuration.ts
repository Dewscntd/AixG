export default () => ({
  ...
  ml: {
    ...
    gpuMemoryLimit: process.env.GPU_MEMORY_LIMIT ? parseInt(process.env.GPU_MEMORY_LIMIT, 10) : undefined
  },
  ...
  stream: {
    ...
    healthCheckInterval: parseInt(process.env.HEALTH_CHECK_INTERVAL_MS || '30000', 10)
  },
  ...
  events: {
    ...
    batchingMaxMessages: parseInt(process.env.EVENT_BATCHING_MAX_MESSAGES || '100', 10),
    batchingMaxDelayMs: parseInt(process.env.EVENT_BATCHING_MAX_DELAY_MS || '100', 10)
  },
