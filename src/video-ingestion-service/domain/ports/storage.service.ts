...
export interface StorageService {
  upload(stream: ReadableStream, metadata: UploadMetadata): Promise<StorageResult>;
  resumeUpload(uploadId: string, stream: ReadableStream, offset: number): Promise<StorageResult>;
