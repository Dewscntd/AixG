...
export const FootballArbitraries = {
  ...
  possessionSequence: () =>
    fc
      .array(FootballArbitraries.possessionEvent(), {
        minLength: 1,
        maxLength: 20,
      })
...
export const PropertyTestUtils = {
   ...
   */
  testCommutative: <T>(fn: (a: T, b: T) => T, arbitrary: fc.Arbitrary<T>) =>
   ...
   */
  testAssociative: <T>(fn: (a: T, b: T) => T, arbitrary: fc.Arbitrary<T>) =>
